...
**Configuration:** If you want to change the average number of episodes or solving window required to consider an agent, you can do that at the top of the `(agent name)_env.py` files.
